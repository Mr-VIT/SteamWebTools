...
'craftAllAvailableConfirm' : 'Вы уверены, что хотите запустить крафт всех доступных значков?',
...
'searchin' : 'Искать на',
'viewMyCardsGame' : 'Посмотреть мои карты/значок этой игры',
'badgeAnotherVersion' : 'Другая Версия',
...
"set.sellLowPriceCheck": "Запрашивать подтверждение продажи если введенная цена ниже продаваемого на этот % (0 - выкл)",
"sellLowPriceCheck.warnTitle":"Steam Web Tools - ⚠Предупреждает:\n",
"sellLowPriceCheck.warning":"Указанная вами цена сильно ниже текущей. Вы уверены, что хотите выставить предмет по такой цене?",
"sellLowPriceCheck.warning2":"Для продолжения подтвердите вводом цену продажи",
"sellLowPriceCheck.loadErr":"Не удалось получить текущую цену на предмет. Самостоятельно проверьте текущую и введеную цену. Выставить предмет по вашей цене?",
